...
export default function HeroSection({ img, text1, text2, text3, button }) {
  return (
    <>  
      <div className="lg:w-4/12  hidden lg:flex -mt-12" >
      ...
      <div data-aos="fade-down" className="  md:ml-5 lg:ml-10 w-full lg:w-8/12 flex-col text-white  lg:px-10  px-5 md:-my-20 ">
        ...
        <button className=" hover:scale-105 mt-4 sm:flex  btn  border-transparent font-bold   py-1 px-0.5 lg:py-3 lg:px-6 rounded-full bg-white  w-8/12 sm:w-4/12  text-black text-sm font-bold hover:bg-white hover:scale-1.5">
        {button}
      </button>
      </div>
    </>
